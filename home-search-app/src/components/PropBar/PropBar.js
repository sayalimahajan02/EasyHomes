    ...
    return (
      ...
      <div class="contServ">
              ...
              <div class="cservicesR">
                  <div class="colRc">
                      <h2>Appartment</h2>
                      <img class="serviceImg" src={Imgone}/>
                  ...
                  <div class="colCc">
                      <h2>Condos</h2>
                      <img class="serviceImg" src={Imgtwo}/>
                      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit, obcaecati amet, iusto dolores harum
                          asperiores
                          labore ipsam voluptates alias sunt</p>
                  </div>
                  <div class="colOc">
                      <h2>Homes</h2>
                      <img class="serviceImg" src={Imgthree}/>
                      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit, obcaecati amet, iusto dolores harum
                          asperiores
                          labore ipsam voluptates alias sunt</p>
                  </div>
                  <div class="colSc">
                      <h2>Studio</h2>
                      <img class="serviceImg" src={Imgfour}/>
                      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit, obcaecati amet, iusto dolores harum
                          asperiores
                          labore ipsam voluptates alias sunt</p>
                  </div>
